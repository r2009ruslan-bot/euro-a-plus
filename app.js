...
const translations = {
    ru: {
        ...
        product1_name:"Amazon Light Gray", product1_specs:"Размер: 60×120 см • Цвет: светло-серый • Матовая • Производство: Иран", product1_desc:"Элегантная матовая плитка Amazon Light Gray. Идеально подходит для гостиной, спальни и кухни. Устойчива к загрязнениям, легко моется. Придает интерьеру современный и стильный вид.",
        product2_name:"Luna", product2_specs:"Размер: 60×120 см • Цвет: белый • Глянцевая • Производство: Иран", product2_desc:"Роскошная глянцевая плитка Luna. Отражает свет, визуально расширяет пространство. Отлично подходит для ванной комнаты, прихожей и кухонного фартука.",
        product3_name:"Amazon Dark Gray", product3_specs:"Размер: 60×120 см • Цвет: тёмно-серый • Противоскользящая • Производство: Иран", product3_desc:"Стильная плитка Amazon Dark Gray с противоскользящим покрытием R10. Идеальный выбор для пола в прихожей, коридоре и на террасе. Прочная и износостойкая.",
    ...
    en: {
        ...
        product1_name:"Amazon Light Gray", product1_specs:"Size: 60×120 cm • Color: light gray • Matte • Made in Iran", product1_desc:"Elegant matte Amazon Light Gray tile. Perfect for living room, bedroom and kitchen.",
        product2_name:"Luna", product2_specs:"Size: 60×120 cm • Color: white • Glossy • Made in Iran", product2_desc:"Luxurious glossy Luna tile. Reflects light and visually expands the space.",
    ...
    tr: {
        ...
        product1_name:"Amazon Light Gray", product1_specs:"Ebat: 60×120 cm • Renk: açık gri • Mat • Üretim: İran", product1_desc:"Şık mat Amazon Light Gray fayans. Oturma odası, yatak odası ve mutfak için ideal.",
        product2_name:"Luna", product2_specs:"Ebat: 60×120 cm • Renk: beyaz • Parlak • Üretim: İran", product2_desc:"Lüks parlak Luna fayans. Işığı yansıtır, alanı görsel olarak genişletir.",
    ...
    az: {
        ...
        product1_name:"Amazon Light Gray", product1_specs:"Ölçü: 60×120 sm • Rəng: açıq boz • Tutqun • İstehsal: İran", product1_desc:"Zərif tutqun Amazon Light Gray kafel. Qonaq otağı, yataq otağı və mətbəx üçün ideal.",
        product2_name:"Luna", product2_specs:"Ölçü: 60×120 sm • Rəng: ağ • Parlaq • İstehsal: İran", product2_desc:"Dəbdəbəli parlaq Luna kafel. İşığı əks etdirir, məkanı vizual olaraq genişləndirir.",
    ...
    fa: {
        ...
        product1_name:"Amazon Light Gray", product1_specs:"ابعاد: ۶۰×۱۲۰ سانتی‌متر • رنگ: خاکستری روشن • مات • ساخت: ایران", product1_desc:"کاشی مات شیک Amazon Light Gray. ایده‌آل برای اتاق نشیمن، اتاق خواب و آشپزخانه.",
        product2_name:"Luna", product2_specs:"ابعاد: ۶۰×۱۲۰ سانتی‌متر • رنگ: سفید • براق • ساخت: ایران", product2_desc:"کاشی براق لوکس Luna. نور را منعکس می‌کند و فضا را بزرگتر نشان می‌دهد.",
...
// ============================================================
// ===== СОРТИРОВКА С ОЧЕНЬ ПЛАВНОЙ АНИМАЦИЕЙ =====
// ============================================================
...
function sortProducts(sortType) {
    ...
    cards.forEach((card, index) => {
        card.style.transition = `all 0.5s cubic-bezier(0.4, 0, 0.2, 1) ${index * 0.06}s`;
    ...
    setTimeout(() => {
        ...
        // Вставляем с задержкой для каждого элемента
        ...
        // Убираем класс appear после анимации
        setTimeout(() => {
            document.querySelectorAll('.product-card.appear').forEach(card => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sortSelect) {
        sortSelect.addEventListener('change', function() {
            ...
            localStorage.setItem('euroSortType', sortType);
        });
        
        const savedSort = localStorage.getItem('euroSortType');
        if (savedSort) {
